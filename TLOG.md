...
| a witness that cosigns us | **same-sponsor** `notbefore.net/witness/ryzen` (`witness/nbwitness.py`, LAN) — a second system, not independence; **independent witnesses: Witness Network participation requested by Bill 2026-09-12 (staging list); awaiting approval** |
