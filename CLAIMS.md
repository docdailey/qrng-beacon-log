...
- ✅ The CLI shipped 2026-09-12 (`cli/`, package `notbefore` 0.2.0). Until it is on PyPI, say "install from the repository"; never say "pip install notbefore" before the release exists.
