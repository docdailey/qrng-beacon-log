...
**Spec:** [`PROTOCOL.md`](PROTOCOL.md) (normative) · **Product contract:** [`NOTBEFORE.md`](NOTBEFORE.md) (the seed \(V\) and the labeled derive layer; draft 0.2) · **CLI:** `pip install notbefore` ([`cli/`](cli/), PyPI 0.2.0: `notbefore verify|value|seed|shuffle|split`, pinned vendored verifier) · **Claims discipline:** [`CLAIMS.md`](CLAIMS.md) ·
